...
Usage:
    from nimbus.llm import AnthropicV2Client, GeminiV2Client, OpenRouterV2Client
...
from nimbus.llm.anthropic import AnthropicV2Client, AnthropicV2Response
from nimbus.llm.gemini import GeminiV2Client, GeminiV2Response
from nimbus.llm.openrouter import OpenRouterV2Client, OpenRouterV2Response
