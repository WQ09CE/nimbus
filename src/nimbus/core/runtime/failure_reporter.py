...
class FailureReporter:
    ...
    def _generate_template_report(self, ctx: FailureContext) -> str:
        ...
        if fault_code == "EXCESSIVE_FAILURES":
            return (
                "I tried multiple approaches but couldn't find what I was looking for. "
                "The files or patterns you mentioned might not exist in this workspace. "
                "Could you double-check the paths or provide more details?"
            )
