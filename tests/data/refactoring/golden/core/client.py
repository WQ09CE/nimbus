...
class APIClient:
    ...
    is new_api() which handles the communication with the server.

    Example:
        client = APIClient(base_url="https://api.example.com")
        result = client.new_api("/users", method="GET")
    """
    ...
    def connect(self) -> bool:
        ...
        """
        # Test connection using new_api
        response = self.new_api("/health", method="GET")
