...
- core/client.py: Main APIClient class with new_api() method
- core/utils.py: Utility functions that use client.new_api()
- services/auth.py: Authentication service using client.new_api()
